...
--
-- Hôte : localhost
-- Généré le : dim. 28 sep. 2025 à 19:52
...
(29, 5, 1, 2, NULL, 'collaboration_request', 'Nouvelle demande de collaboration', 'christian ROUPIOZ vous invite à collaborer sur le projet \"Dev junior\"', 'read', '2025-09-26 19:25:30', '2025-09-28 10:16:06', '/collaboration/requests', '{\"project_id\": 2, \"collaboration_request_id\": 16}'),
(30, 7, 1, 2, NULL, 'collaboration_request', 'Nouvelle demande de collaboration', 'christian ROUPIOZ vous invite à collaborer sur le projet \"Dev junior\"', 'read', '2025-09-26 19:26:34', '2025-09-27 11:28:34', '/collaboration/requests', '{\"project_id\": 2, \"collaboration_request_id\": 17}');
...
(2, 1, 'Dev junior', 'Trouver une entreprise pour un poste de Dev Junior', '2025-09-02 13:03:12', '2025-09-28 10:16:18');
...
(2, 1, 'Faire le Readme', 'Présentation du projet pour Github', 'completed', 'medium', '2025-09-30 10:25:00', '2025-09-02 12:43:38', 5, '2025-09-22 15:47:01', '2025-09-22 15:47:01'),
(3, 2, 'Mettre à jour le CV', NULL, 'todo', 'high', '2025-10-31 12:44:00', '2025-09-02 13:04:56', 3, '2025-09-26 19:03:41', NULL),
...
(18, 1, 'Faire le MCD et le MLD', NULL, 'completed', 'medium', '2025-09-30 17:02:00', '2025-09-09 15:02:50', 7, '2025-09-22 15:47:12', '2025-09-22 15:47:12');
...
CREATE TABLE `user` (
  ...
  `token_registration` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
